...
if ($path === '' || $path === 'index.php') {
    ...
    $page_subtitle = '404';
    $page_content = '<p>' . __('return_home') . '</p>';
    ...
    <header class="header-section">
        <div class="logo-container">
            <div class="hero-welcome-row">
                <section class="hero-promo" aria-label="<?php echo __('recommended_domains'); ?>">
                    ...
                    <?php else: ?>
                        <a class="hero-promo-main" href="<?php echo h($homeWelcome['hero']['text']['main_url'] ?? '#'); ?>" target="_blank" rel="noopener">
                            ...
                            <span class="hero-promo-link"><?php echo h($homeWelcome['hero']['text']['link_text'] ?? ''); ?></span>
                        </a>
                ...
                <section class="welcome-showcase" aria-label="<?php echo __('brand_showcase'); ?>">
    ...
    <div class="modal-overlay" id="detailModal">
        <div class="modal modal-large">
            <div class="modal-header">
                <div class="modal-title" id="detailDomainName"><?php echo __('domain_detail'); ?></div>
            ...
            <div class="modal-body">
                <div class="detail-grid">
                    <div class="detail-item">
                        <div class="detail-label"><?php echo __('domain_type'); ?></div>
                        <div class="detail-value" id="detailType"></div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label"><?php echo __('domain_suffix_label'); ?></div>
                ...
                <div class="domain-intro">
                    <div class="domain-intro-title"><?php echo __('domain_intro'); ?></div>
        ...
        <div class="modal">
            ...
            <div class="modal-body">
                <form onsubmit="submitInquiry(event)">
                    ...
                    <div class="form-footer">
                        <button class="btn btn-secondary" type="button" onclick="closeModal('inquiryModal')"><?php echo __('cancel'); ?></button>
